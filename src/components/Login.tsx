...
export default function Login() {
  ...
  const newAccount = (location.state as { newAccount?: boolean } | null)?.newAccount ?? false;
    ...
    <div className="login">
      <div className="login__shell">
        <form className="login__card" onSubmit={submit}>
          ...
          <div className="login__field">
            ...
            <input
              ...
              defaultValue={newAccount ? "" : "jenaholt@ups.com"}
              disabled={!newAccount}
            />
          </div>
          <div className="login__field">
          ...
          <button type="button" className="login__google" onClick={() => navigate("/portal")}>
        ...
        <div className="login__aside" aria-hidden="true">
          ...
          <span className="login__blob login__blob--4" />
        </div>
      </div>
    </div>
  );
